...
// One needs CLI11 with some methods made virtual. https://github.com/CLIUtils/CLI11/pull/340
...
void Flags::Parse(int argc, char** argv) {
  ...
  ninjaGroup->add_option(app.add_flag("--use_ninja_validations", use_ninja_validations));
  ...
  debugGroup->add_option(app.add_flag("--dump_include_graph", dump_include_graph));
  debugGroup->add_option(app.add_flag("--dump_variable_assignment_trace", dump_variable_assignment_trace));
  ...
  auto warn_real_no_cmds_or_depsPref = app.add_option("--warn_real_no_cmds_or_deps", warn_real_no_cmds_or_deps);
  warningsControl->add_option(warn_real_no_cmds_or_depsPref);
warningsControl->add_option(app.add_flag_callback("--werror_real_no_cmds_or_deps", [&](){werror_real_no_cmds_or_deps=warn_real_no_cmds_or_deps=true;})); // ToDo: ->sets(warn_real_no_cmds_or_depsPref)
  auto warn_real_no_cmdsPref = app.add_option("--warn_real_no_cmds", warn_real_no_cmds);
  warningsControl->add_option(warn_real_no_cmdsPref);
  warningsControl->add_option(app.add_flag_callback("--werror_real_no_cmds", [&](){warn_real_no_cmds=werror_real_no_cmds=true;}));  // ToDo ->sets(warn_real_no_cmdsPref);
